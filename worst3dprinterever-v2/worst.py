...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--out_dir", type=str, help="output directory, default is input name less extension")
    parser.add_argument("-p", "--pages_per_inch", type=int, default=250,
                        help="Number of pages stacked up to make an inch, related to the weight of the paper used,"
                             " default is 250")
