...
# version 2.1 I'm finding running this script on openSUSE is producing a KeyError because PIL.Image.SAVE.keys() is []
...
def image_init(startcount):
    ...
    # testfont = ImageFont.truetype("arial.ttf", 28) # Windows
    testfont = ImageFont.truetype("Hack-Regular.ttf", 28)  # openSUSE
